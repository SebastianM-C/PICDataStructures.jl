...
approx_target_size(::LatticeGrid{1}, ::ScalarQuantity) = 18000
approx_target_size(::LatticeGrid{2}, ::ScalarQuantity) = 6000
approx_target_size(::LatticeGrid{3}, ::ScalarQuantity) = 400
